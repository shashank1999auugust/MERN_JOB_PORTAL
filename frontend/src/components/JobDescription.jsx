  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Total Experience:<span className="pl-4 font-normal text-gray-800">4</span></h1>
        <h1 className="font-bold my-1">Posted Date:<span className="pl-4 font-normal text-gray-800">29-08-2024</span></h1>
      </div>
    </div>
  );
};
